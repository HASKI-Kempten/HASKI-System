        ...
        <>
            <Container maxWidth="sm">
                ...
                <Typography variant="body1" gutterBottom>
                    This site demonstrates the individual elements used in the HASKI UI. It serves as a reference, as well as a documentation.
                </Typography>
                ...
                <Stack spacing={2} sx={{ height: '100%' }} direction="row">
                    ...
                    <Button color="secondary" size="large">Other</Button>
                ...
                <Stack spacing={2} sx={{ height: '100%' }} direction="row">
                    ...
                    <Button variant="outlined" color="secondary">Other</Button>
