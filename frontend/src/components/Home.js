        ...
        <Grid item xs={12} md={9}>
          ...
          >
            <Grid columnSpacing={{ xs: 1, sm: 2, md: 3 }} container>
              <Grid item xs={6}>
                <DashElement link="/learningPath" heading="zuletzt" title="Halstead C++ Übung" subtitle="Qualitätssicherung durch Metriken" buttonText="weiter" text="1/10 bearbeitet" />
              </Grid>
              <Grid item xs={6}>
